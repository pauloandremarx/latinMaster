...
class ReadQuery extends Builder
{
    ...
    public function __construct()
    {
        ...
        if (!$connection) {
            // Lidar com o caso em que a conexão com o banco de dados não está disponível
            // Por exemplo, retornar um valor padrão ou fornecer um comportamento alternativo
            return null;
        }
    }
    ...
    public function paginate(int $itemsPerPage = 10)
    {
        ...
        // Continuar com a lógica de paginação normal

...
{% block content %}
   <section class="bg_formularios_c">
      <div class="uk-container" uk-height-viewport="expand: true">
         ...
         <form class="uk-margin-medium-top" action="{{ path_for('servidor.edit', {'id': servidores.id }) }}" method="POST" enctype="multipart/form-data" id="form" name="formulario">
            <fieldset class="uk-fieldset">
               <div class="uk-margin w535">
                  <p class="title_form">
                     E-mail:
                  </p>
                  <input class="uk-input" name="email" maxlength="399" type="text" value="{{ servidores.email }}"></div>
                  <div class="uk-margin w535">
                     <p class="title_form">
                        Nome:
                     </p>
                     <input class="uk-input" name="nome" maxlength="399" type="text" value="{{ servidores.nome }}"></div>
                     <div class="uk-margin w535">
                        <p class="title_form">
                           Password:
                        </p>
                        <input class="uk-input" name="password" maxlength="399" type="password" value="{{ servidores.password }}"></div>
                        <div class="uk-margin w535">
                           <p class="title_form uk-margin-top">
                              Servidor de e-mail:
                           </p>
                           <input class="uk-input" name="servidor" maxlength="399" type="text" value="{{ servidores.servidor }}"></div>
                           <div class="uk-margin w535">
                              <p class="title_form uk-margin-top">
                                 Porta de e-mail:
                              </p>
                              <input class="uk-input" name="porta" maxlength="5" type="number" value="{{ servidores.porta }}"></div>
                              <div class="uk-grid">
                                 <div class="uk-margin">
